            ...
            <button
              ...
              <div className="pe-6">
                ...
                <Text className="hidden leading-[1.85] @2xl:block">
                  Before placing an order with a large payment amount, We recommend contacting the
                  card issuing bank/institution to avoid the bank flagging your payment or
                ...
                <AdvancedRadio
                  ...
                  <span className="flex flex-col gap-4 @md:flex-row @md:items-center @md:gap-6">
                    ...
                    <span className="block">
                      <Title as="h6" className="mb-2.5 block text-base font-medium @md:mb-2">
                        {item.name}
                      </Title>
                      <Text as="span" className="block font-normal leading-[1.85] @md:pe-10">
                        {item.description}
                      </Text>
                    </span>
                  </span>
