    ...
    <WidgetCard
      ...
      description={
        <>
          ...
          <Badge renderAsDot className="me-0.5 ms-4 bg-[#B8C3E9] dark:bg-[#7c88b2]" /> Expense
        </>
      }
            ...
            <ComposedChart
              ...
              <defs>
                <linearGradient id="salesReport" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#F0F1FF" className=" [stop-opacity:0.1]" />
                  <stop offset="95%" stopColor="#8200E9" stopOpacity={0} />
                </linearGradient>
              </defs>
              <CartesianGrid strokeDasharray="8 10" strokeOpacity={0.435} />
              <XAxis dataKey="month" axisLine={false} tickLine={false} />
              <YAxis axisLine={false} tickLine={false} tick={<CustomYAxisTick prefix={'$'} />} />
              <Tooltip
                content={<CustomTooltip className="[&_.chart-tooltip-item:last-child]:hidden" />}
              />
              <Bar dataKey="revenue" fill="#282ECA" stackId="a" shape={<RoundedBottomBar />} />
              <Bar
                dataKey="expense"
                stackId="a"
                fill="#B8C3E9"
                fillOpacity={0.9}
                shape={<RoundedTopBar className="fill-[#B8C3E9] dark:fill-[#7c88b2]" />}
              />
              <Area
                type="bump"
                dataKey="revenue"
