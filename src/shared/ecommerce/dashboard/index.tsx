...
import BestSellers from 'shared/ecommerce/dashboard/best-sellers';
import RepeatCustomerRate from 'shared/ecommerce/dashboard/repeat-customer-rate';
import UserLocation from 'shared/ecommerce/dashboard/user-location';
...
import StockReport from 'shared/ecommerce/dashboard/stock-report';
    ...
    <div className="@container">
      <div className="grid grid-cols-1 gap-6 @4xl:grid-cols-2 @7xl:grid-cols-12 3xl:gap-8">
        <WelcomeBanner
          title={
            <>
              Good Morning, <br /> Cameron <HandWaveIcon className="inline-flex h-8 w-8" />
            </>
          }
          ...
          media={
            <div className="absolute -bottom-6 end-4 hidden w-[300px] @2xl:block lg:w-[320px] 2xl:-bottom-7 2xl:w-[330px]">
              <div className="relative">
                ...
                /> */}
                <img src="" alt="Welcome shop image form freepik" />
              </div>
            </div>
          }
