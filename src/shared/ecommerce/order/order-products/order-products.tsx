...
const initialData = [
  {
    ...
    product: {
      name: 'Prada Bag',
      image: 'https://isomorphic-furyroad.s3.amazonaws.com/public/products/1.webp',
    },
    price: '$175.00',
    quantity: 1,
  },
  {
    ...
    product: {
      name: 'Leather Bag',
      image: 'https://isomorphic-furyroad.s3.amazonaws.com/public/products/2.webp',
    },
    price: '$55.00',
    quantity: 1,
  },
  {
    ...
    product: {
      name: 'Brown Purse',
      image: 'https://isomorphic-furyroad.s3.amazonaws.com/public/products/3.webp',
    },
    price: '$160.00',
    quantity: 2,
  },
  {
    ...
    product: {
      name: 'Pink Purse',
      image: 'https://isomorphic-furyroad.s3.amazonaws.com/public/products/4.webp',
    },
    price: '$24.00',
    quantity: 1,
  },
  {
    ...
    product: {
      name: 'Prada Clutch',
      image: 'https://isomorphic-furyroad.s3.amazonaws.com/public/products/5.webp',
    },
    price: '$345.99',
    quantity: 1,
  },
...
export const getColumns = ({ sortConfig, onDeleteItem, onHeaderCellClick }: Columns) => [
  ...
  },
  {
    ...
    key: 'quantity',
    width: 200,
    render: (quantity: number) => <Text className="text-center text-sm">{quantity}</Text>,
  },
  {
...
export default function OrderProducts() {
  const { isLoading, sortConfig, tableData, handleSort, handleDelete } = useTable(initialData);
