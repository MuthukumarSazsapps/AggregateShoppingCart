...
import { billingAddressAtom, orderNoteAtom, shippingAddressAtom } from 'store/checkout';
...
const transitions = [
  {
    ...
    paymentMethod: {
      name: 'MasterCard',
      image: 'https://isomorphic-furyroad.s3.amazonaws.com/public/payment/master.png',
    },
    price: '$1575.00',
  },
  {
    ...
    paymentMethod: {
      name: 'PayPal',
      image: 'https://isomorphic-furyroad.s3.amazonaws.com/public/payment/paypal.png',
    },
    price: '$75.00',
  },
  {
    ...
    paymentMethod: {
      name: 'Stripe',
      image: 'https://isomorphic-furyroad.s3.amazonaws.com/public/payment/stripe.png',
    },
    price: '$375.00',
  },
];
    ...
    <div className="@container">
      ...
      <div className="items-start pt-10 @5xl:grid @5xl:grid-cols-12 @5xl:gap-7 @6xl:grid-cols-10 @7xl:gap-10">
        ...
        <div className="space-y-7 pt-8 @container @5xl:col-span-4 @5xl:space-y-10 @5xl:pt-0 @6xl:col-span-3">
          <WidgetCard title="Order Status" childrenWrapperClass="py-5 @5xl:py-8 flex">
          ...
          <WidgetCard title="Customer Details" childrenWrapperClass="py-5 @5xl:py-8 flex">
          ...
          {!isEmpty(shippingAddress) && (
            <WidgetCard title="Billing Address" childrenWrapperClass="@5xl:py-6 py-5">
              <Title as="h3" className="mb-2.5 text-base font-semibold @7xl:text-lg">
