  ...
  if (status === 0) {
    ...
    return (
      <>
        ...
        />
        <Text className="pt-1.5 text-[13px] text-gray-500">{status} low stock</Text>
      </>
    );
  } else {
    return (
      <>
        ...
        />
        <Text className="pt-1.5 text-[13px] text-gray-500">{status} in stock</Text>
      </>
    );
  }
}
  ...
  },
  {
    title: (
      <HeaderCell
        title="Stock"
        sortable
        ascending={sortConfig?.direction === 'asc' && sortConfig?.key === 'stock'}
      />
    ),
  ...
  },
  {
    ...
    render: (_: string, row: ProductType) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        <Tooltip size="sm" content={() => 'View Product'} placement="top" color="invert">
