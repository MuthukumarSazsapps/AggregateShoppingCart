...
import CartProduct from 'shared/ecommerce/cart/cart-product';
...
function CartCalculations() {
  ...
  return (
    <div>
      <Title as="h2" className="border-b border-gray-200 pb-4 text-lg font-medium">
        Cart Totals
      </Title>
      <div className="mt-6 grid grid-cols-1 gap-4 @md:gap-6">
        ...
        <Link to={routes.eCommerce.checkout}>
          <Button
            size="xl"
            rounded="pill"
            // onClick={() => router.push(routes.eCommerce.checkout)}
            onClick={() => navigate(routes.eCommerce.checkout)}
