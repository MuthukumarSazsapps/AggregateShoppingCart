...
import { Navigation, Swiper, SwiperSlide } from 'components/ui/carousel/carousel';
...
export default function ProductCarousel({ title, data, className }: ProductCarouselProps) {
      ...
      <div className="mb-5 flex items-center justify-between">
        ...
        <div className="flex items-start gap-4">
          <ActionIcon
            rounded="full"
            variant="outline"
            className={cn('disabled:bg-gray-100 disabled:text-gray-300', prevButtonClassName)}>
