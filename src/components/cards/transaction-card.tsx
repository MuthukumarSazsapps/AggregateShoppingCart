...
export default function TransactionCard({ className, transaction }: TransactionCardProps) {
  const { icon, title, amount, increased, percentage, iconWrapperFill } = transaction;
  const Icon = icon;
  return (
    <div
      className={cn(
      ...
      <div className="mb-4 flex items-center gap-5">
        <span
          ...
          className={cn('flex rounded-[14px] p-2.5 text-gray-0 dark:text-gray-900')}>
