...
import { FlightingCardProps } from 'utils/types';

export default function FlightBookingCard({ data }: { data: FlightingCardProps }) {
  return (
    <>
      <div key={data.id} className="rounded-lg border border-gray-200">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-t border-dashed border-gray-200 p-5 md:flex-nowrap">
          <div className="text-gray-500">
            <Text as="span" className="text-lg font-semibold text-gray-700 md:text-2xl">
              {data.price}
            </Text>{' '}
    ...
    <Collapse
        ...
        <div
          ...
          <div className="flex gap-2 sm:items-center md:gap-4">
            <div className="relative aspect-square w-20">
              ...
              /> */}
              <img src={flight.image} alt={flight.title} className="h-full w-full object-contain" />
            </div>
              ...
              <ul className="flex items-center divide-x">
                {flight.meta &&
                  Object.entries(flight.meta).map(([key, value]) => {
                    return (
                      <li key={key} className="hidden px-1.5 md:block first:block first:ps-0">
                        {value}
                      </li>
                    );
                  })}
      ...
      <div className="grid items-center gap-4 @container sm:grid-cols-2 lg:gap-6 xl:grid-cols-12">
        <div className="p-3 @xl:p-4 @2xl:p-5 xl:col-span-7">
          <div className="grid grid-cols-8">
            ...
            <div className="relative col-span-1 mt-1.5">
              <span className="relative block mb-1.5 h-3 w-3 rounded-full bg-gray-900 before:absolute before:-left-1.5 before:-top-1.5 before:-z-10 before:h-6 before:w-6 before:rounded-full before:bg-white dark:bg-gray-900 dark:before:bg-gray-50"></span>
          ...
          {flight.routes?.layover?.map((layover, index) => (
            <div key={index} className="grid grid-cols-8">
              ...
              <div className="relative col-span-1 mt-1.5">
                ...
                <Text
                  as="span"
                  className="absolute left-[5px] top-[18px] block h-full w-[2px] bg-gray-200"></Text>
              </div>
              <div className="col-span-7 flex flex-col pb-9 lg:col-span-5">
                <Text as="span" className="font-semibold text-gray-900">
                  {layover?.layoverTime}
          ...
          <div className="grid grid-cols-8">
            ...
            <div className="relative z-10 col-span-1 mt-1.5">
              <Text
                as="span"
                className="relative -bottom-[38px] block h-3 w-3 rounded-full bg-gray-900 before:absolute before:-left-1.5 before:-top-1.5 before:-z-10 before:h-6 before:w-6 before:rounded-full before:bg-gray-0 dark:bg-gray-900 dark:before:bg-gray-50 lg:-bottom-[22px]"></Text>
              <Text
                as="span"
                className="absolute -top-[2px] left-[5px] -z-20 block h-full w-[2px] bg-gray-200"></Text>
            </div>
        ...
        <div className="relative hidden h-[228px] @2xl:block xl:col-span-5">
          ...
          /> */}
          <img src="/map.webp" alt="Qatar Logo" />
        </div>
      </div>
    </Collapse>
  );
