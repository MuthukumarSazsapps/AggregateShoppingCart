...
export default function POSDrawerView({
  ...
  return (
    <div
      className={cn(
        'sticky top-3 xl:top-24 flex h-[calc(100vh-120px)] flex-col justify-between rounded-lg border border-gray-200 pb-7',
        className,
      )}>
      <DrawerHeader
        title="Order"
      ...
      {!!orderedItems?.length && (
        <div className="border-t border-gray-300 p-5 pb-0 lg:p-7">
          ...
          <div className="flex flex-col gap-4">
            <Button className="h-11 w-full" isLoading={loading} onClick={handleOrder}>
              Order Now
            </Button>
          </div>
        </div>
