...
import { filterOptions, initialState } from './pos-category-utils';
...
export default function POSProductCategory() {
  ...
  return (
    <div
      ref={ref}
      className="flex w-full items-center gap-2.5 overflow-x-auto pb-[1px] [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      <Button
