  ...
  return (
    <Collapse
      ...
      <div className="-mt-2 pb-7">
        ...
        <Text className="mb-3 last:mb-0">Pay on delivery might be available</Text>
        <Text className="mb-3 last:mb-0">Easy 14 days returns and exchanges</Text>
        <Text className="mb-3 last:mb-0">Try & Buy might be available for some products</Text>
      </div>
    </Collapse>
  );
}
