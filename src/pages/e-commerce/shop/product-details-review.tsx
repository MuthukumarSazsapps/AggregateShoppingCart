...
import ProductReviewForm from '../product/product-review-form';
...
const reviewData = [
  {
    id: 1,
    rating: 4,
    description: 'Satisfactory in every way. Service and quality were top notch',
  ...
  },
  {
    ...
    date: '15 June, 2023',
    images: ['https://isomorphic-furyroad.s3.amazonaws.com/public/products/review/2.webp'],
  },
];
...
function AverageRatings({ totalReviews, ratings, ratingCount }: AverageRatingsProps) {
  //TODO: need to check
  ...
  return (
    <div className="w-full pb-7 @lg:flex @lg:flex-wrap">
      ...
      <div className="space-y-3 py-0.5 @lg:ps-10 @5xl:w-auto">
        <RatingProgressBar label={5} ratingCount={3} totalReviews={totalReviews!} />
        <RatingProgressBar
          label={4}
          ratingCount={4}
