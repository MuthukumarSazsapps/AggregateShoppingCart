...
export const productFormSchema = z.object({
  ...
  retailPrice: z.coerce.number().min(1, { message: messages.retailPriceIsRequired }),
  salePrice: z.coerce.number().min(1, { message: messages.salePriceIsRequired }),
  ...
  shippingPrice: z.coerce.number().min(1, { message: messages.shippingPriceIsRequired }),
